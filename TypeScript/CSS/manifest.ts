...
export const CSS_TARGETS: readonly CssTarget[] = [
  ...
  { path: "UI/components.css", kind: "ui", firstLine: "/* Adlaire-Design public components */", sourceModules: ["rules.ts", "rules-components.ts"], migrated: true },
  { path: "UI/site.css", kind: "ui", firstLine: "/* Adlaire-Design site chrome */", sourceModules: ["rules.ts", "rules-site.ts"], migrated: true },
  { path: "UI/forms.css", kind: "ui", firstLine: "/* Adlaire-Design form components */", sourceModules: ["rules.ts", "rules-forms.ts"], migrated: true },
  { path: "UI/content.css", kind: "ui", firstLine: "/* Adlaire-Design content components */", sourceModules: ["rules.ts", "rules-content.ts"], migrated: true },
  ...
  { path: "EditorUI/wysiwyg.css", kind: "editor-ui", firstLine: "/* Adlaire-Design WYSIWYG editor */", sourceModules: ["rules.ts", "rules-wysiwyg.ts"], migrated: true },
] as const;
